...
def test_process_archives_invoice_and_stores_document_metadata(
    ...
    document_text = "Musterversand Rechnung RE-123 vom 11.03.2026 ueber 42,50 EUR"
    classification = {
    ...
    row = documents[0]
    assert row[1] == "2026-03-11_Musterversand_RE-123_42EUR.pdf"
    assert row[2] == str(
        Path("archive")
        / "2026"
        / "Rechnungen"
    ...
    search_results = search.search_documents("Musterversand")
