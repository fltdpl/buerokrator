...
def test_find_document_by_hash(tmp_path, monkeypatch):
    ...
    document_id = insert_document(
        filename="2024-01-01_Musterversand.pdf",
        archive_path="archive/2024/Rechnungen/2024-01-01_Musterversand.pdf",
        document_type="invoice",
        extracted_data={},
        content_hash="abc123",
    )

    assert find_document_by_hash("abc123") == (document_id, "2024-01-01_Musterversand.pdf")
...
def test_neues_dokument_wird_mit_hash_gespeichert(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda path: {
            ...
            "extracted_data": {"issuer": "Musterversand", "document_date": "01.01.2024"},
