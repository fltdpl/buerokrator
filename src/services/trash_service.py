...
from src.organizer.trash import TRASH_DIR
...
def list_trash(trash_dir=TRASH_DIR):
...
def restore_from_trash(name, trash_dir=TRASH_DIR, inbox_dir=None):
    ...
    """
    source = Path(trash_dir) / Path(name).name
...
def empty_trash(trash_dir=TRASH_DIR):
