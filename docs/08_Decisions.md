...
- [003 Streamlit](decisions/003_streamlit.md)
- [004 Projektstruktur](decisions/004_folder_structure.md)
- [005 OCR-Strategie](decisions/005_OCR_strategy.md)
- [006 Archivstruktur](decisions/006_archive_structure.md)
- [007 Modellwahl](decisions/007_gemma3.md)
- [008 Regeln vor LLM](decisions/008_rule_classifier_first.md)
- [009 Feld-Whitelist](decisions/009_field_whitelist.md)
...
- [015 Mehrbenutzer über Profile](decisions/015_mehrbenutzer_profile.md) —
  Schritte 1–2 gebaut, Rest geplant
